...
·
[Projection System Guide](./Documentation/How%20to%20Use%20the%20Unity%20Projection%20System.pdf)
·
[Projection Validation](./Documentation/Validation_of_OffAxisProjection_Accuracy.pdf)
...
This repository contains the core implementation scripts, documentation, questionnaires, study materials, and processed analysis files developed for a projection-based augmented reality (PBAR) training system for energy-saving behaviour.
...
- a window,
- blinds,
- indoor comfort and air-quality information,
- energy-cost information, and
...
- [`How to Use the Unity Projection System.pdf`](./Documentation/How%20to%20Use%20the%20Unity%20Projection%20System.pdf)
- [`Validation_of_OffAxisProjection_Accuracy.pdf`](./Documentation/Validation_of_OffAxisProjection_Accuracy.pdf)
...
│
├── Data_Analysis/
│   ├── PBAR_Questionnaire_Results.xlsx
│   ├── VR_Questionnaire_Results.xlsx
│   └── PBAR_VR_Comparison.xlsx
│
├── Documentation/
...
| File | Description |
|---|---|
| `Data_Analysis/PBAR_Questionnaire_Results.xlsx` | Processed questionnaire results from the PBAR pilot study, including presence and immersion, cybersickness, training experience, and System Usability Scale (SUS) results. |
| `Data_Analysis/VR_Questionnaire_Results.xlsx` | Processed results from the three questionnaire sections used in the original VR study: presence and immersion, cybersickness, and training experience. |
| `Data_Analysis/PBAR_VR_Comparison.xlsx` | Comparative analysis of the questionnaire results from the PBAR pilot study and the original VR study. |
| `Documentation/Unity_Scripts_Overview.docx` | Overview and documentation of the Unity scripts used in the project. |
| `Documentation/How to Use the Unity Projection System.pdf` | Documentation for configuring and using the Unity projection system. |
| `Documentation/Validation_of_OffAxisProjection_Accuracy.pdf` | Geometric validation of the implemented off-axis projection method. |
| `Documentation/Participant Information and Consent Form.pdf` | Participant information and consent material used for the pilot study. |
...
```text
Documentation/How to Use the Unity Projection System.pdf
```
